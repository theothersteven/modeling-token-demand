...
- [When work is limited, total surplus eventually plateaus](#24-capability-raises-the-work-limited-reservation-token-price); [when human attention is limited, it can grow without bound](#34-capability-raises-the-value-of-scarce-attention). Finite work caps the total value models can create. In the attention limited regime, better models allow each review hour support progressively more AI output, increasing the total surplus for the world.
